...
<head>
  ...
  <style>
    ...
    .navbar-nav .nav-link:hover {
      color: #000 !important;
      /* Darker shade on hover if needed */
    }
  </style>
    ...
    <div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="img/cover1.png" class="d-block mx-auto w-100" alt="...">
          ...
          <div class="container">
            <div class="carousel-caption text-start">
              <h1>Matte Black</h1>
              <p class="opacity-75">Fuck Fin and Jake doing crime again!</p>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <div class="carousel-caption">
              <img src="img/gelo.png" class="d-block w-100" alt="...">
              <h1>HALO RING.</h1>
